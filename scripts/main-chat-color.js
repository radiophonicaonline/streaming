...
function actualizarContenido() {
  ...
  if (iframe) {
    iframe.src = "https://eva-fail-laser-wine.trycloudflare.com/nowplaying.txt?t=" + timestamp;
  }

  const portada = document.getElementById("portadaCancion");
  if (portada) {
    portada.src = "https://eva-fail-laser-wine.trycloudflare.com/artwork.png?t=" + timestamp;
  }
}
